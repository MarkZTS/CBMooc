    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.SmallIntegerField(choices=[(0, '初级'), (1, '中级'), (2, '高级')], verbose_name='难度')),
                ...
                ('course_known', models.CharField(default='', max_length=300, verbose_name='课程须知')),
                ('teacher_tell', models.CharField(default='', max_length=300, verbose_name='学习到的技能')),
                ('tag', models.CharField(default='', max_length=10, verbose_name='课程标签')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='teachers.Teacher', verbose_name='授课教师')),
            ],
            options={
                'verbose_name': '课程',
